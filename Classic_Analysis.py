...
#bist = endeks
def classic_analysis(Stock_List):
    stock_dict = {}
    stock_data = []
    stock_number = 0
    for stocks in Stock_List:
        ...
        try:
            ...
            historical_data = ticker.history(period="40d",interval="5m")  # Get historical data for the stock
            ...
            #historical_data['psar']= ta.psar("historical_data"["High"], historical_data['Low'], historical_data['Close'])
