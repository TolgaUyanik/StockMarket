...
portfolio = ["KRDMD.IS","CCOLA.IS","BRSAN.IS","ARCLK.IS","HEKTS.IS","MIATK.IS","ZOREN.IS","SMRTG.IS", "MAVI.IS","TTRAK.IS","EGPRO.IS","AEFES.IS","FROTO.IS","ALCAR.IS"] 
...
def classic_analysis(bist):
    ...
    df1 = df[["symbol","time", "StochRSI_K","StochRSI_D","MACDAS-dif","MACDAS","MACDAS_Signal", 'BB_BWidth', 'BB_%B',"YF%","MFI", "RSI", "ADX", "CCI", "ROC","CMF", "ATR","FWMA","VWAP","Supertrend","Supertrend_direction","kama", "Tenkan","Kijun","Senkou_A","Senkou_B","Cloud_Position","TK_Cross","currentPrice","change"]]
